...
class MainScr(Screen):
    def __init__ (self, **kwards):
        ...
        # test_btn1 = Button(text = 'текстова копка 1')
        # test_btn2 = Button(text = 'текстова копка 2')
        # test_btn3 = Button(text = 'текстова копка 3')
        # test_btn4 = Button(text = 'текстова копка 4')
